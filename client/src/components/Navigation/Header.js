            ...
            <div className="h-16 flex items-center">
                      ...
                      {({ open }) => (
                        <>
                          ...
                          <Transition
                            ...
                            leaveTo="opacity-0"
                          >
                            <Popover.Panel className="absolute top-full inset-x-0 text-sm text-gray-200 transition duration-300">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="flex lg:ml-6">
                  <a href="#" className="duration-300 p-2 text-white hover:text-gray-400">
